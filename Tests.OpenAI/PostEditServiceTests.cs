...
public class PostEditServiceTests : TestBase
{
    ...
    private IXliffService _xliffService = null!;
    private IGlossaryService _glossaryService = null!;
    private IOpenAICompletionService _openAICompletionService = null!;
    ...
    public void Setup()
    {
        _xliffService = new XliffService(FileManagementClient);
        _glossaryService = new GlossaryService(FileManagementClient);
        _openAICompletionService = new OpenAICompletionService(new Apps.OpenAI.Api.OpenAIClient(Creds));
        _postEditService = new PostEditService(
            _xliffService,
            _glossaryService,
            _openAICompletionService,
