...
[TestClass]
public class JsonGlossaryServiceTests : TestBaseWithContext
{
    ...
    public async Task BuildGlossaryPromptAsync_WithFiltering_ReturnsOnlyRelevantEntriesInJson(InvocationContext context)
    {
        // Arrange
        var translationUnits = new List<TranslationUnit>
        {
